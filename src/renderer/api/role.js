...
export function allqueryRoleApi(data) {
...
export default {allqueryRoleApi,queryRoleApi,roleInfoApi,saveRoleApi,updateRoleApi,deleteRoleApi,selectDept,selectMenu,queryAllRoleApi}
